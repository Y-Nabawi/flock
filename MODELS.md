...
Scan the column that matches your hardware, then pick by use case. ⭐ = recommended starting point in each row. Catalog has **27 models** as of v0.21.0 (run `flock model search` for the live list).
